...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropImageExample.personal_web'
        db.add_column(u'Team_Images_cropimageexample', 'personal_web',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropImageExample.personal_web'
        db.delete_column(u'Team_Images_cropimageexample', 'personal_web')
