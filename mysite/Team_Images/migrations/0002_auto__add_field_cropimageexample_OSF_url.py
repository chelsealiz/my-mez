...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropImageExample.OSF_url'
        db.add_column(u'Team_Images_cropimageexample', 'OSF_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropImageExample.OSF_url'
        db.delete_column(u'Team_Images_cropimageexample', 'OSF_url')
